...
This repo contains a file called Favs.txt that you can use to test the programs function that calls 
a pre-existing text file to be read in as the user adds more things to the list.
